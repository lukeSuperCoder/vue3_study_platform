    ...
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <RegisterForm
          ...
          @update:changeDisplayValue="changeDisplayValue"
        />
      </div>
    </div>
    <!-- 左右切换动画 -->
...
<script lang='ts'>
import { ref } from "vue";
import { loginUser, loginRules } from "@/util/loginValidators";
...
export default {
  ...
  setup() {
    ...
    let changeDisplayValue = (value:any) => {
      signUpMode.value = !signUpMode.value
      console.log('恭喜您注册成功，请登陆');
    }
    return {
      signUpMode,
      LoginForm,
